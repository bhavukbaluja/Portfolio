exports.id = 418, exports.ids = [418], exports.modules = {
          ...
          children: [(0, t.jsxs)("label", {
            ...
            children: (0, t.jsx)(Object(function () {
              ...
              onChange: (e, o) => {
                ...
                let l = a.slice(o.dialCode.length);
                l.trim() ? /^\d{7,15}$/.test(l) || (t = "Invalid mobile number (7-15 digits required).") : c && (t = "This field is required."), n(e => {
                  let r = {
                    ...e
                  };
  ...
  5411: (e, r, o) => {
    ...
    let b = ({
      ...
      let A = async (r, t) => {
        let a = (0, i.jr)("otp", t);
        if (E(a), !(0, i.Im)(a)) return;
        o(!0);
        let l = {};
        l.otp = t, l.mobileOrEmail = r, await D(s.JV, l).then(r => {
          if ((0, i.Im)(r?.status) || r?.status && r?.status < 300) {
            if (r?.accessToken && r?.userInfo) {
              let {
                accessToken: e,
                userInfo: o
              } = r;
              U(JSON.parse(o), e), N(!1);
            }
          ...
          children: [(0, t.jsxs)("div", {
            ...
            children: [(0, t.jsx)("div", {
              ...
              children: (0, t.jsx)(m, {
                ...
                handleChange: e => {
                  let r, o;
                  e?.target ? (r = e?.target?.name, o = e?.target?.value) : o = e, C(o), (0, i.Im)(r) && (r = "otp"), E((0, i.jr)(r, o));
                },
                errorMsg: w
              })
            })]
      ...
      let {
        ...
        R = () => {
          ...
          return Object.keys(F).forEach(r => {
            ...
            F[r]?.toString().trim() || (e[r] = "This field is required.");
          }), e;
        },
        H = async e => {
          let r;
          e.preventDefault(), o(!0), "mobile" == M ? (delete F.email, r = F?.mobile) : "email" == M && (delete F.mobile, r = F?.email), "otp" == S && delete F.password, delete F.otp;
          let t = R();
          if (U(t), Object.keys(t).length > 0) return void o(!1);
          G(r);
        },
        z = (e, r) => {
          F?.hasOwnProperty(e) || (F[e] = ""), "selected" == r ? L(e) : "selectedPassword" == r && k(e);
        },
        $ = async e => {
          o(!0), E("resend"), await G(e), E("submit");
        },
        G = async e => {
          let r = {};
          r.password = F.password, r.mobileOrEmail = e || F.email || F.mobile, await C(m.Mh, r).then(e => {
            if (e?.accessToken && e?.userInfo) {
              let {
                accessToken: r,
                userInfo: o
              } = e;
              A(JSON.parse(o), r), x(Date.now()), g(!1);
            }
            N(e?.message || e), P(e);
          }).catch(e => {}), o(!1);
        };
      return (0, t.jsx)(t.Fragment, {
        children: (0, u.Im)(y) && (0, u.Im)(T.get("mobileOrEmail")) ? (0, t.jsxs)(Object(function () {
          ...
          children: [(0, t.jsx)(l.A, {
            ...
            value: S,
            onChange: e => z(e, "selectedPassword")
            ...
            className: "form-button-container",
            children: (0, t.jsx)("button", {
              disabled: e || "email" == M && !(0, u.Im)((0, u.jr)("email", F?.email)) || "mobile" == M && !(0, u.Im)((0, u.jr)("mobile", F?.mobile)) || "" == S || "password" == S && !(0, u.Im)((0, u.jr)("password", F?.password)),
              type: "submit",
              className: "form-button",
              onClick: H,
          ...
          setLoading: o,
          loading: e,
          value: (0, u.Im)(T.get("mobileOrEmail")) ? "mobile" == M ? F?.mobile : F?.email : T.get("mobileOrEmail"),
          showSnackBar: N,
          setAlertMsg: O,
          setAlertTitle: r,
          setOpenAlert: f,
