exports.id = 150, exports.ids = [150], exports.modules = {
  ...
  2150: (e, t, r) => {
    ...
    function h(e, t) {
      ...
      return o.polyfillFiles.filter(e => e.endsWith(".js") && !e.endsWith(".module.js")).map(e => (0, n.jsx)("script", {
        defer: !i,
        nonce: t.nonce,
    ...
    function m({
      ...
      return (0, n.jsx)("style", {
        ...
        dangerouslySetInnerHTML: {
          __html: t.map(e => e.props.dangerouslySetInnerHTML.__html).join("").replace(/\/\*# sourceMappingURL=.*\*\//g, "").replace(/\/\*@ sourceURL=.*?\*\//g, "")
        }
      });
    }
    function E(e, t, r) {
    ...
    function S(e, t, r) {
      ...
      return [...r.allFiles.filter(e => e.endsWith(".js")), ...(null == (o = i.lowPriorityFiles) ? void 0 : o.filter(e => e.endsWith(".js")))].map(e => (0, n.jsx)("script", {
    ...
    class b extends o.default.Component {
      ...
      getPreloadDynamicChunks() {
        ...
        return e.map(e => e.endsWith(".js") ? (0, n.jsx)("link", {
          rel: "preload",
          href: `${t}/_next/${(0, c.encodeURIPath)(e)}${r}`,
          as: "script",
          nonce: this.props.nonce,
      ...
      getPreloadMainLinks(e) {
        ...
        return [...(o.beforeInteractive || []).map(e => (0, n.jsx)("link", {
          nonce: this.props.nonce,
          rel: "preload",
          href: e.src,
          as: "script",
          crossOrigin: this.props.crossOrigin || a
        }, e.src)), ...i.map(e => (0, n.jsx)("link", {
          nonce: this.props.nonce,
          rel: "preload",
          href: `${t}/_next/${(0, c.encodeURIPath)(e)}${r}`,
          as: "script",
      ...
      getBeforeInteractiveInlineScripts() {
        ...
        return (e.beforeInteractive || []).filter(e => !e.src && (e.dangerouslySetInnerHTML || e.children)).map((e, n) => {
          let {
              strategy: a,
              children: i,
            ...
            c = "";
          return s && s.__html ? c = s.__html : i && (c = "string" == typeof i ? i : Array.isArray(i) ? i.join("") : ""), (0, o.createElement)("script", {
            ...u,
            dangerouslySetInnerHTML: {
              __html: c
            },
      ...
      render() {
        ...
        let {
          ...
          T = [];
        N && (N.forEach(e => {
          e && "link" === e.type && "preload" === e.props.rel && "style" === e.props.as ? this.context.strictNextHead ? P.push(o.default.cloneElement(e, {
            "data-next-head": ""
          })) : P.push(e) : e && (this.context.strictNextHead ? T.push(o.default.cloneElement(e, {
            "data-next-head": ""
          })) : T.push(e));
        }), N = P.concat(T));
        ...
        N = o.default.Children.map(N || [], e => {
          ...
          if (a) {
            let n = "";
            if ("meta" === t && "viewport" === r.name ? n = 'name="viewport"' : "link" === t && "canonical" === r.rel ? x = !0 : "script" === t && (r.src && -1 > r.src.indexOf("ampproject") || r.dangerouslySetInnerHTML && (!r.type || "text/javascript" === r.type)) && (n = "<script", Object.keys(r).forEach(e => {
              n += ` ${e}="${r[e]}"`;
            }), n += "/>"), n) return console.warn(`Found conflicting amp tag "${e.type}" with conflicting prop ${n} in ${l.page}. https://nextjs.org/docs/messages/conflicting-amp-tag`), null;
        ...
        let M = _(this.context.buildManifest, this.context.__NEXT_DATA__.page, a),
          ...
          j = ((0, p.getTracedMetadata)((0, d.getTracer)().getTracePropagationData(), this.context.experimentalClientTraceMetadata) || []).map(({
            key: e,
            value: t
          }, r) => (0, n.jsx)("meta", {
            name: e,
      ...
      static getInlineScriptSource(e) {
        ...
        try {
          ...
          let a = Buffer.from(o).byteLength,
            i = r(7730).A;
          return n && a > n && (g.add(t.page), console.warn(`Warning: data for page "${t.page}"${t.page === e.dangerousAsPath ? "" : ` (path "${e.dangerousAsPath}")`} is ${i(a)} which exceeds the threshold of ${i(n)}, this amount of data can reduce performance.
See more info here: https://nextjs.org/docs/messages/large-page-data`)), (0, s.htmlEscapeJsonString)(o);
        } catch (e) {
          if ((0, l.default)(e) && -1 !== e.message.indexOf("circular structure")) throw Object.defineProperty(Error(`Circular structure in "getInitialProps" result of page "${t.page}". https://nextjs.org/docs/messages/circular-structure`), "__NEXT_ERROR_CODE", {
            value: "E490",
            enumerable: !1,
            configurable: !0
          });
      ...
      render() {
        ...
        return (0, n.jsxs)(n.Fragment, {
          children: [!u && r.devFiles ? r.devFiles.map(t => (0, n.jsx)("script", {
            src: `${e}/_next/${(0, c.encodeURIPath)(t)}${i}`,
            nonce: this.props.nonce,
            crossOrigin: this.props.crossOrigin || l
          }, t)) : null, u ? null : (0, n.jsx)("script", {
            id: "__NEXT_DATA__",
        ...
        o.default.Children.forEach(p, t => {
          ...
          if (t && (null == (r = t.type) ? void 0 : r.__nextScript)) {
            if ("beforeInteractive" === t.props.strategy) {
              ...
              return;
            } else if (["lazyOnload", "afterInteractive", "worker"].includes(t.props.strategy)) return void l.push(t.props);else if (void 0 === t.props.strategy) return void l.push({
              ...t.props,
    ...
    (() => {
      ...
      var t = {
              ...
              constructor() {
                ...
                t.setLogger = (e, r = {
                  ...
                  if (u && !r.suppressOverrideMessage) {
                    ...
                    u.warn(`Current logger will be overwritten from ${e}`), c.warn(`Current logger will overwrite one already registered from ${e}`);
                  }
          ...
          172: (e, t, r) => {
            ...
            t.registerGlobal = function (e, t, r, n = !1) {
              ...
              if (i.version !== o.VERSION) {
                let t = Error(`@opentelemetry/api: Registration of version v${i.version} for ${e} does not match previously registered API v${o.VERSION}`);
                return r.error(t.stack || t.message), !1;
              }
          ...
          651: (e, t) => {
            Object.defineProperty(t, "__esModule", {
              value: !0
            }), t._globalThis = void 0, t._globalThis = "object" == typeof globalThis ? globalThis : global;
          },
          46: function (e, t, r) {
            var n = this && this.__createBinding || (Object.create ? function (e, t, r, n) {
                void 0 === n && (n = r), Object.defineProperty(e, n, {
          ...
          614: (e, t, r) => {
            ...
            class l {
              startSpan(e, t, r = s.active()) {
                ...
                return "object" == typeof (n = l) && "string" == typeof n.spanId && "string" == typeof n.traceId && "number" == typeof n.traceFlags && (0, i.isSpanContextValid)(l) ? new a.NonRecordingSpan(l) : new a.NonRecordingSpan();
              }
  ...
  5600: (e, t, r) => {
    ...
    let n = r(6848),
      ...
      a = r(7108);
    function i(e) {
      let t = /^\/index(\/|$)/.test(e) && !(0, o.isDynamicRoute)(e) ? "/index" + e : "/" === e ? "/index" : (0, n.ensureLeadingSlash)(e);
      {
        let {
            posix: e
          } = r(3873),
  ...
  7730: (e, t) => {
    ...
    function o(e, t) {
      if (!Number.isFinite(e)) throw Object.defineProperty(TypeError(`Expected a finite number, got ${typeof e}: ${e}`), "__NEXT_ERROR_CODE", {
        value: "E572",
        enumerable: !1,
        configurable: !0
      });
    ...
    class v {
      ...
      trace(...e) {
        ...
        let f = this.getSpanContext((null == c ? void 0 : c.parentSpan) ?? this.getActiveScopeSpan()),
          m = !1;
        f ? (null == (t = l.getSpanContext(f)) ? void 0 : t.isRemote) && (m = !0) : (f = (null == i ? void 0 : i.active()) ?? d, m = !0);
        let S = E();
        return c.attributes = {
          "next.span_name": p,
          "next.span_type": r,
          ...c.attributes
        }, i.with(f.setValue(h, S), () => this.getTracerInstance().startActiveSpan(p, c, e => {
          let t = "performance" in globalThis && "measure" in performance ? globalThis.performance.now() : void 0,
            n = () => {
              _.delete(S), t && process.env.NEXT_OTEL_PERFORMANCE_PREFIX && o.LogSpanAllowList.includes(r || "") && performance.measure(`${process.env.NEXT_OTEL_PERFORMANCE_PREFIX}:next-${(r.split(".").pop() || "").replace(/[A-Z]/g, e => "-" + e.toLowerCase())}`, {
                start: t,
                end: performance.now()
              });
            };
