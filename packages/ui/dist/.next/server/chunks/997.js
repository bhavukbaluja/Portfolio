exports.id = 997, exports.ids = [997], exports.modules = {
      ...
      return (0, a.jsxs)(Object(function () {
        ...
        children: [(0, a.jsxs)(Object(function () {
          ...
          children: [(0, a.jsx)(Object(function () {
            ...
            className: `${t().Input} ${"password" === b && !j ? t().passwordInput : ""}`,
            value: p,
            onChange: e => _({
              target: {
                name: m,
  ...
  3039: (e, r, o) => {
    ...
    let s = () => {
      ...
      return {
        getAboutUs: async (r, o) => await e(r, "GET", o),
        register: async (r, o) => await e(r, "POST", o),
        validateOtp: async (r, o) => await e(r, "POST", o),
        login: async (r, o) => await e(r, "POST", o),
        updateAboutUs: async (r, o) => await e(r, "POST", o),
        updateDetails: async (r, o) => await e(r, "POST", o)
      };
    };
  },
  3987: () => {
      ...
      let j = (0, s.useRef)(null),
        ...
        L = e => {
          ...
          if (n(e => ({
            ...e,
            [a]: s
          })), "password" === a) for (let o of (P(e), y(s), v)) if (o.regex.test(s)) i(e => {
            let r = {
              ...e
            };
            return delete r[a], r;
          });else {
            let e = t.A[r].passReqNotFulfil;
            i(r => ({
              ...r,
              [a]: e
            }));
          ...
          if ("confirmPassword" == a) if (o?.password != s) {
            let e = t.A[r].confirmPasswordNotMatchPassword;
            i(r => ({
              ...r,
              [a]: e
            }));
        ...
        T = e => {
          !x.current || x?.current?.contains(e?.relatedTarget) || j?.current?.contains(e.relatedTarget) || (g(null), D(!1));
        };
              ...
              children: ({
                ...
                children: (0, a.jsx)(Object(function () {
                  ...
                  children: (0, a.jsxs)(Object(function () {
                    ...
                    children: [v.map(e => (0, a.jsxs)(Object(function () {
                      var e = Error("Cannot find module '__barrel_optimize__?names=Box,ClickAwayListener,Grow,LinearProgress,Paper,Popper,Typography!=!@mui/material'");
                      throw e.code = "MODULE_NOT_FOUND", e;
                    }()), {
                      sx: {
                        display: "flex",
                        alignItems: "center",
                        color: e.regex.test(o?.password) ? Object(function () {
                          var e = Error("Cannot find module '../../../Config/Theme'");
                          throw e.code = "MODULE_NOT_FOUND", e;
                      ...
                      children: [e.regex.test(o?.password) ? (0, a.jsx)(Object(function () {
                        var e = Error("Cannot find module '@mui/icons-material/CheckCircle'");
                        throw e.code = "MODULE_NOT_FOUND", e;
                      }()), {
                        fontSize: "small"
    ...
    let _ = ({
      ...
      let [j, x] = (0, s.useState)({
        ...
        E = async () => {
          o(!0);
          let r = {};
          r.password = j?.password, r.mobileOrEmail = n, "update" == h && (r.oldPassword = j?.oldPassword), await N(u.yF, r).then(r => {
          ...
          children: [(0, a.jsx)("div", {
            ...
            SubmitButton: "update" == h ? (0, a.jsxs)("div", {
              ...
              children: [(0, a.jsx)("button", {
                ...
                disabled: j?.password == "" || j?.confirmPassword == "" || j?.password != j?.confirmPassword || j?.oldPassword == "",
