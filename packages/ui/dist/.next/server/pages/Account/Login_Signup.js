(() => {
  ...
  e.id = 26, e.ids = [26, 220], e.modules = {
      ...
      let f = ({
        ...
        let {
          ...
          F = async e => {
            ...
            let t = {};
            if ("mobile" !== A ? (delete w.mobile, delete w.countryCode) : delete w.email, Object.keys(w).forEach(e => {
              if ("countryCode" !== e) {
                let r = (0, m.jr)(e, w[e]);
                (0, m.Im)(r) || (t[e] = r);
              }
              w[e]?.toString().trim() || (t[e] = "This field is required.");
            }), U(t), Object.keys(t).length > 0) return void r(!1);
            B();
          },
          k = async e => {
            r(!0), D("resend"), await B(e), D("submit");
          },
          B = async e => {
            let t = {};
            t.fullName = w.fullName, t.mobileOrEmail = e || w.email || w.mobile, await v(u.Am, t).then(e => {
              h(e), P(e);
            }).catch(e => {}), r(!1);
          };
        return (0, o.jsx)(o.Fragment, {
          children: (0, m.Im)(y) && (0, m.Im)(M.get("mobileOrEmail")) ? (0, o.jsxs)(Object(function () {
            ...
            setLoading: r,
            loading: e,
            value: (0, m.Im)(M.get("mobileOrEmail")) ? "mobile" == A ? w?.mobile : w?.email : M.get("mobileOrEmail"),
            showSnackBar: h,
            setAlertMsg: f,
            setAlertTitle: t,
            setOpenAlert: g,
    ...
    9237: (e, t, r) => {
      ...
      let x = ({
        ...
        open: o,
        setOpen: n
      }) => (Array.isArray(t) || (t = []), (0, u.jsx)(O.A, {
        title: r || "Alert",
        bodyComponent: (0, u.jsx)(() => (0, u.jsxs)("div", {
          style: {
            display: "flex",
  ...
  t.C(e);
  var r = e => t(t.s = e),
    o = t.X(0, [150, 775, 997, 418], () => r(9237));
  module.exports = o;
})();