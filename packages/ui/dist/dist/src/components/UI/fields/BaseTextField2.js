...
function BaseTextField2(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_field.Field.Root, {
    ...
    className: "".concat(_BaseModule["default"].Input),
    value: value,
    ...
    style: {
      resize: 'vertical',
      width: '100%'
    } // Ensure full width and resize is enabled
    ...
    multiline: multiline,
    rows: rows
  }), type === 'password' && !multiline && /*#__PURE__*/React.createElement(_IconButton["default"], {
