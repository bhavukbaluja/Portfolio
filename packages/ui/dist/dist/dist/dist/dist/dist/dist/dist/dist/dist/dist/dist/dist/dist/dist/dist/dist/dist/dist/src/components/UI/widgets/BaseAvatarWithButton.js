...
var StyledIconButton = (0, _material.styled)(_material.IconButton)(function (_ref) {
...
var AvatarWithUpdate = function AvatarWithUpdate(_ref2) {
  var imageUrl = _ref2.imageUrl,
    name = _ref2.name,
    _ref2$size = _ref2.size,
    size = _ref2$size === void 0 ? 300 : _ref2$size,
    onImageUpdate = _ref2.onImageUpdate;
  var _useState = (0, _react.useState)(null),
    _useState2 = _slicedToArray(_useState, 2),
    imageBlobUrl = _useState2[0],
    setImageBlobUrl = _useState2[1];
    ...
    _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _Helper.loadProfileImage)(imageUrl);
          case 2:
  ...
  var handleOptionClick = function handleOptionClick(source) {
    switch (source) {
      case 'camera':
  ...
  var handleFileChange = function handleFileChange(event) {
    ...
    if (file) {
      onImageUpdate === null || onImageUpdate === void 0 || onImageUpdate(event); // or handle the file directly here
    }
  };
  ...
  }, "Upload from Files")), /*#__PURE__*/_react["default"].createElement("input", {
    ref: fileInputRef,
    type: "file",
    accept: "image/*",
    hidden: true,
...
var _default = exports["default"] = AvatarWithUpdate;