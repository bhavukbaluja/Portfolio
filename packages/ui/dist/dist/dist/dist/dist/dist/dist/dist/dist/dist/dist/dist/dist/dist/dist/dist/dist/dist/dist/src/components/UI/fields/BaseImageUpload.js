...
var BaseImageUpload = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  var _useState = (0, _react.useState)(null),
    ...
    openCropper = _useState2[0],
    setOpenCropper = _useState2[1];
  var _useState3 = (0, _react.useState)(false),
    _useState4 = _slicedToArray(_useState3, 2),
    isCropper = _useState4[0],
    setIsCropper = _useState4[1];
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            _context.next = 5;
            return uploadImage(url, formData);
          case 5:
            res = _context.sent;
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return cropImage(_URLs.URL_Crop_Image + entity + "Img", jsonData).then(function (res) {
