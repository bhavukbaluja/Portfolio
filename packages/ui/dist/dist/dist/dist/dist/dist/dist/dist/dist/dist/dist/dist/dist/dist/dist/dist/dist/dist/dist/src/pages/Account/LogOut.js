...
var LogOutPage = function LogOutPage(_ref) {
      ...
      var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              setLoading(true);
              if (!(user !== null && !(0, _Helper.isEmpty)(user))) {
                _context.next = 4;
                break;
              }
              _context.next = 4;
              return logout();
            case 4:
              NavigateTo("/", "/logout", true); // Redirect after logout
              setLoading(false);
            case 6:
            case "end":
...
var _default = exports["default"] = LogOutPage;