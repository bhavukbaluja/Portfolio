...
exports.WebsiteServices = void 0;
...
var WebsiteServices = exports.WebsiteServices = function WebsiteServices() {
  var _useCallApi = (0, _CallApi.useCallApi)(),
    CallApi = _useCallApi.CallApi;
  var setWebsiteEnabled = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
      var url;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            url = _URLs.URL_CONFIG.ADMIN_URL + _URLs.URL_CONFIG.SITE_ENABLED;
            _context.next = 3;
    ...
    return function setWebsiteEnabled(_x) {
  ...
  return {
    ...
    setWebsiteEnabled: setWebsiteEnabled
