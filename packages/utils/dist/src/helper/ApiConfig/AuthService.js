    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios["default"].post(_URLs.URL_CONFIG.API_URL + _URLs.RefreshAccessToken_URL, {}, {
        ...
        case 3:
          ...
          (0, _API_Helper.setAuthToken)(newAccessToken);
          return _context.abrupt("return", newAccessToken);
        case 8:
          _context.next = 14;
          break;
        case 10:
          ...
          (0, _API_Helper.removeAuthDetails)(); // Logout user if refresh fails
        case 14:
...
//       method,
//       url: `${URL_CONFIG.API_URL}${endpoint}`,
//       data,
//       headers: {
//         ...headers,
...
//       if (newToken) {
//         return apiRequest(method, endpoint, data, headers); // Retry with new token
//       }
//     }
//     throw error;
//   }
