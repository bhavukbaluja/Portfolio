...
exports.getStatusCell = exports.getStatus = exports.getServerTimeZone = exports.getRankOptionsByProduct = exports.getRankOptions = exports.getModifiedDateValue = exports.getModifiedDateCell = exports.getManageCommonColumns = exports.getLocalDateTime = exports.getGUITimeFormat = exports.getEllipsisSx = exports.getCommonPopover = exports.getColumnData = exports.fetchImage = exports.encodeEmailOrMobile = exports.decodeUnicode = exports.convertMilisecondsToTimeFormat = exports.convertEntities = exports.convertDateToEpoch = exports.convertDateBack = exports.convertDate = exports.actionColumn = exports.ShowUserId = exports.ShowStartedDate = void 0;
exports.highlightSearchMatch = highlightSearchMatch;
exports.validateField = exports.updateQueryParam = exports.updateBrandName = exports.toTitleCase = exports.removeLoginDetailCookies = exports.paginationData = exports.navigateOnQuickSearch = exports.loadProfileImage = exports.isString = exports.isEmpty = exports.homePagePaginationData = void 0;
...
var _BaseSwitch = _interopRequireDefault(require("@ui/components/UI/widgets/BaseSwitch"));
var _BasePopover = _interopRequireDefault(require("@ui/components/UI/widgets/BasePopover"));
...
var _PanelServices = require("@utils/services/PanelServices");
...
var getStatusCell = exports.getStatusCell = function getStatusCell(params, onToggle) {
  var _params$column2, _params$column2$getSi, _params$row2, _params$row3;
  var columnName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "status";
  var width = params === null || params === void 0 || (_params$column2 = params.column) === null || _params$column2 === void 0 || (_params$column2$getSi = _params$column2.getSize) === null || _params$column2$getSi === void 0 ? void 0 : _params$column2$getSi.call(_params$column2);
  return /*#__PURE__*/_react["default"].createElement(_material.Stack, {
    direction: "row",
    spacing: 1,
    sx: {
      ...
      // this is important
      height: '100%',
      // this ensures it stretches full cell height
      justifyContent: 'center'
    }
  }, /*#__PURE__*/_react["default"].createElement(_BaseSwitch["default"], {
    defaultChecked: (params === null || params === void 0 || (_params$row2 = params.row) === null || _params$row2 === void 0 ? void 0 : _params$row2[columnName]) == 'ACTIVE',
    onToggle: onToggle,
    switchKey: params === null || params === void 0 || (_params$row3 = params.row) === null || _params$row3 === void 0 ? void 0 : _params$row3.id,
    row: params === null || params === void 0 ? void 0 : params.row
  }));
};
var convertEntities = exports.convertEntities = function convertEntities(entities, currentEntityId, status, includeInPath) {
  var results = [];
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      if (currentEntityId != (entity === null || entity === void 0 ? void 0 : entity.id)) {
        if (status != null && status == (entity === null || entity === void 0 ? void 0 : entity.status) || status == null) {
          var result = {};
          result["label"] = entity === null || entity === void 0 ? void 0 : entity.name;
          result["value"] = entity === null || entity === void 0 ? void 0 : entity.id;
          result["path"] = (includeInPath || "") + "/" + (entity === null || entity === void 0 ? void 0 : entity.name.toLowerCase().replace(" ", "_"));
          results.push(result);
        }
      }
    }
...
var getCommonPopover = exports.getCommonPopover = function getCommonPopover(_ref8) {
  var id = _ref8.id,
    anchorPosition = _ref8.anchorPosition,
    setAnchorPosition = _ref8.setAnchorPosition,
  ...
  return /*#__PURE__*/_react["default"].createElement(_BasePopover["default"], {
    id: id,
...
var updateQueryParam = exports.updateQueryParam = function updateQueryParam(key, value) {
...
var getRankOptions = exports.getRankOptions = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(parentCategoryId, fetchSubcategories) {
    var _response;
    var options, response, jsonData, items, currentItem, usedRanks, count, currentRank, i;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 6;
          return fetchSubcategories(_URLs.Category_URL + "/child", jsonData);
        case 6:
        ...
        case 9:
          _context3.next = 11;
          return fetchSubcategories(_URLs.Category_URL + "/allParents");
        case 11:
          response = _context3.sent;
        case 12:
          items = ((_response = response) === null || _response === void 0 ? void 0 : _response.data) || [];
          currentItem = items.find(function (item) {
            return item.id === parentCategoryId;
          });
          usedRanks = (items === null || items === void 0 ? void 0 : items.map(function (item) {
            return item.rank;
          })) || [];
          count = (items === null || items === void 0 ? void 0 : items.length) || 0;
          currentRank = currentItem === null || currentItem === void 0 ? void 0 : currentItem.rank;
          i = 1;
          if (count > 0) {
            for (i = 1; i <= count; i++) {
              // +1 to allow a new rank at the end
  ...
  return function getRankOptions(_x4, _x5) {
    return _ref9.apply(this, arguments);
  };
}();
var getRankOptionsByProduct = exports.getRankOptionsByProduct = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(parentCategoryId, fetchSubcategories, productId) {
    var options, response, items, currentItem, usedRanks, count, currentRank, i;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.next = 4;
          return fetchSubcategories("".concat(_URLs.Product_URL, "/category/").concat(parentCategoryId));
        case 4:
          response = _context4.sent;
          items = (response === null || response === void 0 ? void 0 : response.data) || [];
          currentItem = items.find(function (item) {
  ...
  return function getRankOptionsByProduct(_x6, _x7, _x8) {
