    ...
    >
      ...
      >
        ...
        {user==null ?
          ...
          <Divider />
          <ListItem button component={Link} to="/company/contactUs" onClick={() => handleClose(true)}>
            <ListItemIcon>
              <SupportAgentOutlinedIcon />
            </ListItemIcon>
            <ListItemText primary={Literal[lang].contactUs} className='account-options-list'/>
          </ListItem>
          <ListItem button component={Link} to="/company/aboutUs" onClick={() => handleClose(true)}>
            <ListItemIcon>
              <InfoOutlinedIcon />
            </ListItemIcon>
